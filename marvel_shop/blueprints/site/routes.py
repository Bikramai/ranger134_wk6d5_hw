...
def shop():
    ...
    movie_class = "Marvels Series movies are the best "
                            #whats on left side is html, right side is whats in our route
    return render_template('shop.html', shop=allprods, coolmessage=movie_class) #looking inside our template_folder (site_templates) to find our shop.html file
